...
export const About = () => {
  return (
    <div className="pb-14">
      ...
      <div className="flex justify-between max-w-7xl mx-auto gap-10 pb-9">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-6 mt-11">
            <div className="w-72 h-14 relative bg-gradient-to-r from-sky-400/30 to-indigo-600/30 rounded-[120px] overflow-hidden">
            ...
            <div className="w-72 h-14 relative bg-gradient-to-r from-orange-500/30 to-sky-900/30 rounded-[120px] overflow-hidden">
              <div className="w-full h-full flex justify-center items-center gap-2.5">
            ...
            <div className="w-72 h-14 relative bg-gradient-to-r from-blue-800/30 to-orange-700/30 rounded-[120px] overflow-hidden">
              <div className="w-full h-full flex justify-center items-center gap-2.5">
            ...
            <div className="w-72 h-14 relative bg-gradient-to-r from-amber-600/30 to-sky-500/30 rounded-[120px] overflow-hidden">
              <div className="w-full h-full flex justify-center items-center gap-2.5">
            ...
            <div className="w-72 h-14 relative bg-gradient-to-r from-cyan-400/30 to-orange-200/30 rounded-[120px] overflow-hidden">
              <div className="w-full h-full flex justify-center items-center gap-2.5">
        ...
        <div className="flex gap-7">
          <div className="w-60 h-72 relative bg-gradient-to-b from-sky-500/30 to-sky-950/30 rounded-[75px] outline outline-2 outline-offset-[-2px] outline-sky-500/60 overflow-hidden">
            <div className="w-full h-full flex flex-col justify-center items-center gap-6">
              <p className="self-stretch text-center justify-start text-sky-300 text-6xl font-semibold font-['Unbounded']">
                1.2+
              </p>
              <p className="text-center justify-start text-sky-500 text-2xl font-semibold font-['Unbounded']">
                Years
                <br />
                Experience
              </p>
      ...
      <div className="max-w-7xl mx-auto self-stretch h-80 p-10 relative bg-sky-500/30 rounded-[75px] outline outline-2 outline-offset-[-2px] outline-sky-500/60 overflow-hidden">
