...
import logo from "../../assets/images/projects/learning-gpt-logo.png";
import Home from "../../assets/images/projects/learning-home.png";
import Topics from "../../assets/images/projects/learning-topics.png";
          ...
          {projects.map((project, idx) => (
            ...
            >
              <div className="w-full inline-flex justify-start items-center gap-20">
                {/* Left Section */}
                <div className={`w-1/2 h-[404px] relative ${project.innerBg} rounded-[75px] overflow-hidden`}>
                  <img
                  ...
                  <div className="left-[21px] top-[28px] absolute inline-flex justify-start items-center gap-2.5">
                    ...
                    <p className={`justify-start text-white text-xl font-bold font-unbounded ${project.titleColor}`}>
                      {project.title}
                    </p>
                  </div>
                </div>
                    ...
                    <div className="w-96 flex flex-col justify-start items-start gap-5">
                      <div className="self-stretch flex flex-col justify-start items-start gap-5">
                        <div className="flex flex-col justify-start items-start gap-5">
                          <p className={`justify-start text-4xl font-medium font-unbounded ${project.titleColor}`}>
                            {project.title}
                          </p>
